...
package body Periodic_Tasks is
   ...
   HC_2_1 : High_Crit (Pri => 30, Low_Critical_Budget => 100_000, High_Critical_Budget => 500_000, Workload => 30_000, Period => 1_050_000, CPU_Id => CPU'Last);
   ...
   LC_2_1 : Low_Crit (Pri => 10, Low_Critical_Budget => 300_000, Is_Migrable => True, Workload => 1, Period => 100_000, CPU_Id => CPU'Last);

   LC_2_2 : Low_Crit (Pri => 15, Low_Critical_Budget => 140_000, Is_Migrable => True, Workload => 1, Period => 160_000, CPU_Id => CPU'Last);
